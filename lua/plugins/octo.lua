return {
  ...
  keys = {
    { '<leader>go', '<cmd>Octo<cr>', desc = 'Open Octo (GitHub)' },
    { '<leader>goi', '<cmd>Octo issue list<cr>', desc = 'List GitHub issues' },
    { '<leader>gop', '<cmd>Octo pr list<cr>', desc = 'List GitHub PRs' },
    { '<leader>gor', '<cmd>Octo repo list<cr>', desc = 'List GitHub repos' },
