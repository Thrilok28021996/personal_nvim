return {
  {
    ...
    config = function()
      require('spectre').setup {
        ...
        -- Live update (instant preview)
        live_update = false, -- Auto update when you change text
        ...
        -- Mapping for within spectre buffer
        mapping = {
          ['toggle_line'] = {
            map = 'dd',
        ...
        replace_vim_cmd = 'cdo',
        is_open_target_win = true, -- Open file in previous window
